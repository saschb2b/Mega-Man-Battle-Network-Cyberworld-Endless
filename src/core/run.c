...
void run_new(uint32_t seed) {
	...
	static const uint8_t pools[BIOME_COUNT][3] = {
		...
		{ 3, 4, 11 },   /* Cybeast Nest */
		{ 14, 12, 17 }, /* Comp: CircusMan, BlastMan, Colonel */
		{ 14, 16, 13 }, /* Homepage: CircusMan, ElementMan, DiveMan */
		{ 17, 15, 12 }, /* Comp (second): Colonel, JudgeMan, BlastMan */
	};
...
int biome_bg(int b) {
	...
	static const int bg[BIOME_COUNT] = { 0x07, 0x0B, 0x04, 0x0D, 0x14, 0x0F, 0x13, 0x15, 0x06, 0x03, 0x08 };
