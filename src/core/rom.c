...
static const RomLayout layouts[] = {
	[ROM_BN6_GREGAR_US] = {
		...
		.net_area = {
			...
			{ 0x85, 4, 0x1501, 0x0000, false, 0x20, 0x85, 0, 5 },     /* CopyBot Comp (purple, its rims and pink walkways one floor: its plateaus meet the void only by their rims); the Pavilion comps' battles */
