...
static const RomLayout layouts[] = {
	[ROM_BN6_GREGAR_US] = {
		...
		.net_area = {
			{ 0x90, 0, 0x0018, 0x0040, false, 0x13, 0x90, 0, 3 },     /* Central Area 1; battles of Central 1-3 */
			{ 0x91, 0, 0x0040, 0x0006, false, 0x11, 0x91, 0, 3 },     /* Seaside Area 1; Seaside 1-3 */
			{ 0x94, 1, 0x1000, 0x0140, false, 0x0A, 0x94, 0, 3 },     /* Sky Area 2; Sky 1-3 */
			{ 0x92, 0, 0x0010, 0x0001, false, 0x12, 0x92, 0, 2 },     /* Green Area 1; Green 1-2 */
			{ 0x96, 1, 0x1000, 0x0100, false, 0x09, 0x96, 0, 3 },     /* Graveyard; Graveyard 1-3 */
