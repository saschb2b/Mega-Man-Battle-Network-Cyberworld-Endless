...
static const RomLayout layouts[] = {
	[ROM_BN6_GREGAR_US] = {
		...
		.net_area = {
			{ 0x90, 0, 0x0018, 0x0040, false, 0x13 },     /* Central Area 1 */
			{ 0x91, 0, 0x0040, 0x0006, false, 0x11 },     /* Seaside Area 1 */
			{ 0x94, 1, 0x1000, 0x0140, false, 0x0A },     /* Sky Area 2 */
			{ 0x92, 0, 0x0010, 0x0001, false, 0x12 },     /* Green Area 1 */
			{ 0x96, 1, 0x1000, 0x0100, false, 0x09 },     /* Graveyard */
			{ 0x95, 0, 0x0001, 0x0C00, true, 0x14 },      /* Undernet 1 */
			{ 0x95, 1, 0x1000, 0x0C00, true, 0x20 },      /* Undernet Zero */
			{ 0x93, 1, 0x0004, 0x0000, true, 0x21 },      /* Underground 2 */
		},
		.song_table = 0x159F48,
	},
};
